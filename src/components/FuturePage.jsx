  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow mt-28">
        <h1 className="max-w-[55%] max-md:max-w-[90%] mx-auto font-general uppercase text-lg max-md:text-base m-2 mb-10 text-center">
          <span className="text-3xl text-gray-500 mx-4 max-md:mx-3">~</span>
          {title}
          <span className="text-3xl text-gray-500 mx-4 max-md:mx-3">~</span>
        </h1>
