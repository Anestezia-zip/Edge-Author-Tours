        ...
        <div>
          ...
          {description && (
            <div className="inline-block relative">
              <div className="absolute inset-0 bg-black bg-opacity-70 rounded-md z-0"></div>
              <p className="relative pl-2 pb-2 mt-1 max-w-80 text-xs md:text-base text-white z-10 inline-block">
                {description}
              </p>
            </div>
          )}
