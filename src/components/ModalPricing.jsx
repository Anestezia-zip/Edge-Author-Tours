      ...
      >
        ...
        >
          ...
          <p className="text-gray-600">
            ...
            <span className="font-semibold">$1,000</span>, and we find ways to
            save you <span className="font-semibold">$300</span> through
            exclusive discounts and smarter choices.
          </p>
          ...
          <ul className="text-gray-700 mb-4">
            ...
            <li>
              ...
              <span className="text-blue-700">$45</span> (15% of the savings we
              secure for you)
            </li>
          </ul>
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="text-blue-800 font-bold">$300</span>, so after
            deducting our service fee, you still keep{" "}
            <span className="text-green-600 font-bold">$155</span>{" "}
            <span className="underline">
              in your pocket — all while we handle all:
            </span>{" "}
            the planning, booking, and organizational details.
          </p>
        </div>
      </div>
    </div>
